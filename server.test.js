...
describe('UF Directory Server Unit Tests', function() {
  ...
  describe('Server provides listing data as JSON on proper request', function() {
    it('responds correctly to a GET request to "/getteampairing"', function(done) {
      request.get('http://localhost:5000/getteampairing', function(error, response, body) {
    ...
    it('responds with a 404 error to other GET requests', function(done) {
      request.get('http://localhost:5000/getprojects', function(error, response, body) {
